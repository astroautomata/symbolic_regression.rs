...
fn population_replaces_by_oldest_birth() {
    ...
    let mut m1 = PopMember::from_expr_with_birth(MemberId(1), None, Some(10), leaf_expr(0), 1);
    let mut m2 = PopMember::from_expr_with_birth(MemberId(2), None, Some(20), leaf_expr(0), 1);
    let mut m3 = PopMember::from_expr_with_birth(MemberId(3), None, Some(30), leaf_expr(0), 1);
    ...
    pop.members[2].birth = Some(5);
    assert_eq!(pop.oldest_index(), 2);

    let child = PopMember::from_expr_with_birth(MemberId(99), None, Some(100), leaf_expr(0), 1);
